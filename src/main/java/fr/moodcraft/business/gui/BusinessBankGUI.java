    ...
    public static void open(Player p, Business business) {
        ...
        SafeGUI.set(inv, 4, new ItemBuilder(Material.GOLD_INGOT)
                ...
                .lore(
                        ...
                        "§8• §7Paie/mois : §e" + VaultHook.format(PayrollManager.calculateTotalPayroll(business)),
        ...
        SafeGUI.set(inv, 25, new ItemBuilder(Material.CLOCK)
                .name("§6✦ §fSalaires §6✦")
                .lore(
                        "§8• §7Paie mensuelle",
                        "§8• §7Salaire par rôle",
                        "§8• §7Jour de paie : §e" + Main.getInstance().getConfig().getInt("payroll.default-payday", 1),
                        "",
